...
namespace Ase.Serialization
{
    ...
    public partial class Serializer
    {
        ...
        public void Write(float[] value)
        {
            _PutArray(value, sizeof(float), FastBitConverter.GetBytes);
        }

        public void Write(double[] value)
        {
            _PutArray(value, sizeof(double), FastBitConverter.GetBytes);
        }

        public void Write(long[] value)
        {
            _PutArray(value, sizeof(long), FastBitConverter.GetBytes);
        }

        public void Write(ulong[] value)
        {
            _PutArray(value, sizeof(ulong), FastBitConverter.GetBytes);
        }

        public void Write(int[] value)
        {
            _PutArray(value, sizeof(int), FastBitConverter.GetBytes);
        }

        public void Write(uint[] value)
        {
            _PutArray(value, sizeof(uint), FastBitConverter.GetBytes);
        }

        public void Write(ushort[] value)
        {
            _PutArray(value, sizeof(ushort), FastBitConverter.GetBytes);
        }

        public void Write(short[] value)
        {
            _PutArray(value, sizeof(short), FastBitConverter.GetBytes);
        }

        public void Write(bool[] value)
        {
            _PutArray(value, sizeof(bool), FastBitConverter.GetBytes);
        }
