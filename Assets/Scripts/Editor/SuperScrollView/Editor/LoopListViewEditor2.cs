...
namespace SuperScrollView
{
    ...
    public class LoopListViewEditor2 : Editor
    {
        ...
        SerializedProperty mPaddingTop;
        SerializedProperty mPaddingBottom;
        SerializedProperty mPaddingLeft;
        SerializedProperty mPaddingRight;
        ...
        protected virtual void OnEnable()
        {
            ...
            mPaddingTop = serializedObject.FindProperty("mPaddingTop");
            mPaddingBottom = serializedObject.FindProperty("mPaddingBottom");
            mPaddingLeft = serializedObject.FindProperty("mPaddingLeft");
            mPaddingRight = serializedObject.FindProperty("mPaddingRight");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(mPaddingTop);
            EditorGUILayout.PropertyField(mPaddingBottom);
            EditorGUILayout.PropertyField(mPaddingLeft);
            EditorGUILayout.PropertyField(mPaddingRight);
