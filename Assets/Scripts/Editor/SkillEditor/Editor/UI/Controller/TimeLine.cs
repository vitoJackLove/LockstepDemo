...
public static class TimeLine
{
    ...
    public static void UpdateGUI(SkillTimelineEditorWindow window, int currentFrameID,
    ...
    public static void UpdateCurFrameUI(SkillTimelineEditorWindow window, int currentFrameID, float widthPreFrame,
        Rect rect)
    {
        //绘制当前帧指向线条
        Handles.color = Color.white; // 设置线条颜色
        ...
        Handles.DrawLine(new Vector2(currentFrameRectX , rect.y + rect.height * 0.5f), 
            new Vector2(currentFrameRectX, window.position.yMax)); 
    ...
    private static void ProcessEvent(SkillTimelineEditorWindow window, Rect rect)
    {
