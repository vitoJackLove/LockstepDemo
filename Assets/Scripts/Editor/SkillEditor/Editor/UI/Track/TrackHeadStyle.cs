...
{
    public static void UpdateUI(SkillTimelineEditorWindow window, Rect rect, TrackStyleData data, int trackIndex)
    {
    ...
    private static void ProcessEvent(SkillTimelineEditorWindow window, Rect rect, int trackIndex)
    {
