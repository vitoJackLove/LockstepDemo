...
namespace TheKiwiCoder 
{
    ...
    public class SerializedBehaviourTree {
        ...
        const string conditionChild = nameof(ConditionNode.child);
        ...
        public void AddChild(Node parent, Node child) {
            ...
            // Condition nodes
            var conditionProperty = parentProperty.FindPropertyRelative(conditionChild);
            if (conditionProperty != null) {
                SerializedProperty newChild = AppendArrayElement(conditionProperty);
                newChild.managedReferenceValue = child;
                ApplyChanges();
                return;
            }
        ...
        public void RemoveChild(Node parent, Node child) {
            ...
            var conditionProperty = parentProperty.FindPropertyRelative(conditionChild);
            if (conditionProperty != null) {
                RemoveNodeArrayElement(conditionProperty, child);
                ApplyChanges();
                return;
            }
        }
