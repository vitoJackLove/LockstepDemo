...
{
    public sealed class NetworkProtobufCodec : INetworkPacketCodec
    {
        public int MaxPacketBytes => NetworkPacketCodecProvider.DefaultMaxPacketBytes;

        private const int MessageTypeWireOffset = 1;
        private const int FixedVectorScale = 10000;

        public byte[] SerializePacket(BattleObserverEventEnum messageType, IObserverParams observerParams)
        {
        ...
        public bool TryDeserializePacket(byte[] packetData, out BattleObserverEventEnum messageType, out IObserverParams observerParams)
        {
        ...
        public bool TryGetMessageType(byte[] packetData, out BattleObserverEventEnum messageType)
        {
            messageType = BattleObserverEventEnum.None;
        ...
        private IMessage CreatePayload(BattleObserverEventEnum messageType, IObserverParams observerParams)
        {
            switch (messageType)
            {
        ...
        private IObserverParams ParsePayload(BattleObserverEventEnum messageType, ByteString payload)
        {
            switch (messageType)
            {
                case BattleObserverEventEnum.PlayerConnect:
        ...
        private Proto.PlayerConnectMessage ToProto(global::PlayerConnectMessage message)
        {
        ...
        private global::PlayerConnectMessage ToRuntime(Proto.PlayerConnectMessage message)
        {
        ...
        private Proto.SelectHeroMessage ToProto(global::SelectHeroMessage message)
        {
        ...
        private global::SelectHeroMessage ToRuntime(Proto.SelectHeroMessage message)
        {
        ...
        private Proto.GameStartMessage ToProto(global::GameStartMessage message)
        {
        ...
        private global::GameStartMessage ToRuntime(Proto.GameStartMessage message)
        {
        ...
        private Proto.FrameCommandMessage ToProto(global::FrameCommandMessage message)
        {
        ...
        private global::FrameCommandMessage ToRuntime(Proto.FrameCommandMessage message)
        {
        ...
        private Proto.CommandData ToProto(global::CommandData commandData)
        {
        ...
        private global::CommandData ToRuntime(Proto.CommandData message)
        {
        ...
        private Proto.FixedPointVector3 ToProto(fp3 value)
        {
        ...
        private fp3 ToRuntime(Proto.FixedPointVector3 value)
        {
            if (value == null)
            {
                return fp3.zero;
        ...
        public fp3 QuantizeVector(fp3 value)
        {
            return new fp3(
        ...
        private int ToScaledInt(fp value)
        {
            return Mathf.RoundToInt((float)value * FixedVectorScale);
        }

        private fp ToFixedPoint(int value)
        {
            return (fp)((float)value / FixedVectorScale);
        }

        private int ToWireMessageType(BattleObserverEventEnum messageType)
        {
        ...
        private bool TryFromWireMessageType(int wireMessageType, out BattleObserverEventEnum messageType)
        {
